...
export const projectsData = [
    {
        id: 1,
        projectName: 'Augmented Reality web application',
        projectDesc: 'This project aims to build an interactive web application for Irrigation Department in Sri Lanka byintroducing a remote working online platform based on AR functionality with Project Suggestion, Approval ,Supervision and communication',
